...
echo "PAH-min0.1-h0.0 done" > log_gemma_monitor_base.txt
...
echo "PAH-min0.1-h0.25 done" > log_gemma_monitor_base.txt
...
echo "PAH-min0.1-h0.5 done" > log_gemma_monitor_base.txt
...
echo "PAH-min0.1-h0.75 done" > log_gemma_monitor_base.txt
...
echo "PAH-min0.1-h1.0 done" > log_gemma_monitor_base.txt
...
echo "PAH-min0.3-h0.0 done" > log_gemma_monitor_base.txt
...
echo "PAH-min0.3-h0.5 done" > log_gemma_monitor_base.txt
...
echo "PAH-min0.3-h0.25 done" > log_gemma_monitor_base.txt
...
echo "PAH-min0.3-h0.75 done" > log_gemma_monitor_base.txt
...
echo "PAH-min0.3-h1.0 done" > log_gemma_monitor_base.txt
